  ...
  return (
    ...
    >
        ...
        <div id="responsive-nav">
          ...
          <div id="hamburger-wrapper">
            ...
            <nav className="wide-nav sm:top-18 shadow-tershades-gray max-w-1/2  translate-x-full">
              ...
              <ul className="nav-groups gap-3 justify-end lg:hidden rounded-t-r-3xl flex flex-col-reverse w-full mb-4 ">
      ...
      >
        ...
        <i className="down-btn w-12 h-12" onClick={executeScroll} style={{ opacity: responsiveNavOpen ? 0 : 1 }} />
      </div>
    </div>
  );
};
