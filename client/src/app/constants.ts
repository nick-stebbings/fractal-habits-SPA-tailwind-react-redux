...
export const DB_DATE_ID_OFFSET = import.meta.env.PROD ? 3 : 3; // Accounts for the starting ID of the date relation in the DB, which is not stored locally.
export const HABIT_DATE_BACKGROUND_PERSISTENCE_INTERVAL = 10; // seconds
