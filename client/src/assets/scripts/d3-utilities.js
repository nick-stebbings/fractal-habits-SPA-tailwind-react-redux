...
class Visualization {
  constructor(svg, inputTree) {
    ...
    this.eventHandlers = {
      handleZoom: (event, node, forParent = false) => {
...
// const nodeStatusColours = (d, currentHierarchy) => {
...
export { renderTree, collapseTree, expandTree, makePatchOrPutRequest };
